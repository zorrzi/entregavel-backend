...
connect(host=f"mongodb+srv://{os.getenv('MONGO_USER')}:{os.getenv('MONGO_PWD')}@entregavelcapacitacao.7bacv.mongodb.net/?retryWrites=true&w=majority&appName=EntregavelCapacitacao")
